...
public:
	...
	GuiSiv3D()
	{
		...
		mEvaluator.add(L"multipv_num", GUITextField::Create(1, widgetStyle2));
		...
		mEvaluator.add(L"best_arrow_depth", GUITextField::Create(1, widgetStyle2));
		mEvaluator.addln(L"best_arrow_suffix", GUIText::Create(L"", widgetStyle));
